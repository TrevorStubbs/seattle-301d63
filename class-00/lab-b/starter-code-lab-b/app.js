...
// We WILL need to use a code block
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(message('Jon\'s Beard is Awesome!'));
...
// My answer:
// Am I supposed to make a constructor function into an arrow function? It's not supposed to work.
...
// My attempt to make a prototype an arrow function:
...
// "this" is scoped to the instance of the constructor function
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" is scoped to the browser window
// 3. Explain why "this" is different when an arrow function is used.
// According to MDN an arrow function will scope "this" to the last non-arrow function,
// and if there is no non-arrow functions on the page it will scope to the window. A normal
// function will keep "this" in it's own scope.
